...
export default function LeaveForm(){
  ...
  return <form className="leave-form" onSubmit={submit}>
    <div className="leave-fields"><label><span>من</span><input type="date" name="starts_on" required/></label><label><span>إلى</span><input type="date" name="ends_on" required/></label></div>
